...
def main() -> None:
    ...
    ap.add_argument("--today", default=None, help="Analysis date in YYYY-MM-DD; defaults to UTC current date.")
    ...
    ap.add_argument("--snapshot-tag", default=None, help="Optional snapshot tag (default: YYYY-MM-DD).")
    ap.add_argument("--no-uscis-tail", action="store_true", help="Disable USCIS-tail mixture outputs.")
    args = ap.parse_args()
